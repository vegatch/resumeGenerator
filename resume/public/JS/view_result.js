import {hideForms, displayForm, addEventOnForm} from './test.js'

console.log('works', document.querySelector("#resumeId"))
...
export let loadHtmlForm = (data) =>{
  ...
  personIdInput1.value = `${el.person_id}`
  ...
  personIdInput2.value = `${el.first_name}`
  ...
  personIdInput3.value = `${el.middle_name}`
  ...
  personIdInput4.value = `${el.last_name}`
  ...
  titleInput2.value = `${el.person_id}`
  ...
  contactInput1.value = `${el.contact_id}`
  ...
  contactInput2.value = `${el.person_id}`
  ...
  contactInput3.value = `${el.address_city}`
  ...
  contactInput4.value = `${el.address_state}`
  ...
  contactInput5.value = `${el.address_zcode}`
  ...
  if(el.remote === 'yes'){
    contactInput6.checked = true
  }else{
    contactInput6.checked = false
  }
  ...
  if(el.relocalisation === 'yes'){
    contactInput7.checked = true
  }else{
    contactInput7.checked = false
  }
  ...
  socialInput1.value = `${el.media_id}`
  ...
  socialInput2.value = `${el.person_id}`
  ...
  socialInput3.value = `${el.linkedin_url}`
  ...
  socialInput4.value = `${el.github_url}`
  ...
  socialInput5.value = `${el.portfolio_url}`
  ...
  summaryInput1.value = `${el.objective_id}`
  ...
  summaryInput2.value = `${el.person_id}`
  ...
  summaryInput3.value = `${el.objective_details}`
  ...
  educationInput1.value = `${el.education_id}`
  ...
  educationInput2.value = `${el.person_id}`
  ...
  if(el.field_study === "IT"){
    eduInputRadio1.checked = true
  }
  ...
  if(el.field_study === "Other"){
    eduInputRadio2.checked = true
  }
  ...
  educationInput4.value = `${el.school_name}`
  ...
  educationInput5.value = `${el.school_city}`
  ...
  educationInput6.value = `${el.school_state}`
  ...
  if(el.school_attendance_method === "remote"){
    attendanceInputRadio1.checked = true
  }
  ...
  if(el.school_attendance_method === "inPerson"){
    attendanceInputRadio2.checked = true
  }
  ...
  educationInput8.value = `${el.certificate_title}`
  ...
  if(el.graduated_in_course === "yes"){
    educationInput9.checked = true
  }else{
    educationInput9.checked = false
  }
  ...
  graduationMonthOption10.text = `${el.completion_date_month}`
  ...
  graduationYearOption10.text= `${el.completion_date_year}`
  ...
  educationInput11.value = `${el.achievement_one}`
  ...
  educationInput12.value = `${el.achievement_two}`
  ...
  educationInput13.value = `${el.achievement_three}`
  ...
  techSkillsInput1.value = `${el.tech_skill_id}`
  ...
  techSkillsInput2.value = `${el.person_id}`
  ...
  techSkillsInput3.value = `${el.skill_tech1}`
  ...
  techSkillsInput4.value = `${el.skill_tech2}`
  ...
  techSkillsInput5.value = `${el.skill_tech3}`
  ...
  techSkillsInput6.value = `${el.skill_tech4}`
  ...
  techSkillsInput7.value = `${el.skill_tech5}`
  ...
  techSkillsInput8.value = `${el.skill_tech6}`
  ...
  techSkillsInput9.value = `${el.skill_tech7}`
  ...
  techSkillsInput10.value = `${el.skill_tech8}`
  ...
  techSkillsInput11.value = `${el.skill_tech9}`
  ...
  techSkillsInput12.value = `${el.skill_tech10}`
  ...
  marketSkillsInput1.value = `${el.market_skill_id}`
  ...
  marketSkillsInput2.value = `${el.person_id}`
  ...
  marketSkillsInput3.value = `${el.skill_market1}`
  ...
  marketSkillsInput4.value = `${el.skill_market2}`
  ...
  marketSkillsInput5.value = `${el.skill_market3}`
  ...
  marketSkillsInput6.value = `${el.skill_market4}`
  ...
  marketSkillsInput7.value = `${el.skill_market5}`
  ...
  marketSkillsInput8.value = `${el.skill_market6}`
  ...
  marketSkillsInput9.value = `${el.skill_market7}`
  ...
  marketSkillsInput10.value = `${el.skill_market8}`
  ...
  marketSkillsInput11.value = `${el.skill_market9}`
  ...
  marketSkillsInput12.value = `${el.skill_market10}`
  ...
  projectsInput1.value = `${el.project_id}`
  ...
  projectsInput2.value = `${el.person_id}`
  ...
  projectsInput3.value = `${el.project_role}` 
  ...
  projectsInput4.value = `${el.project_name}`  
  ...
  projectsInput5.value = `${el.project_language_used}`    
  ...
  projectStartMonthOption6.text = `${el.project_month_start}`  
  ...
  projectStartYearOption6.text= `${el.project_year_start}`  
  ...
  if(el.project_completed === 'yes'){
    projectsInput7.checked = true
  }else{
    projectsInput7.checked = false
  }
  ...
  projectEndMonthOption8.text = `${el.project_month_end}` 
  ...
  projectEndYearOption8.text= `${el.project_year_end}` 
  ...
  projectsInput9.value = `${el.project_url}`  
  ...
  projectsInput10.value = `${el.project_achievement_one}`  
  ...
  projectsInput11.value = `${el.project_achievement_two}`  
  ...
  projectsInput12.value = `${el.project_achievement_three}`  
  ...
  if(el.work_type === 'IT'){
    industryInputRadio1.checked = true
  }
  ...
  if(el.work_type === 'Other'){
    industryInputRadio2.checked = true
  }
  ...
  workInput4.value = `${el.company_name}`  
  ...
  workInputCity5.value = `${el.company_city}`  
  ...
  workInputState5.value = `${el.company_state}`  
  ...
  workStartMonthOption7.text = `${el.work_start_month}` 
  ...
  workStartYearOption7.text= `${el.work_start_year}` 
  ...
  if(el.still_work_there === 'yes'){
    workInput8.checked = true
  }else{
    workInput8.checked = false
  }
  ...
  workEndMonthOption9.text = `${el.work_end_month}` 
  ...
  workEndYearOption9.text= `${el.work_end_year}` 
  ...
  workInput10.value =  `${el.work_achievement1}` 
  ...
  workInput11.value =  `${el.work_achievement2}`   
  ...
  workInput12.value =  `${el.work_achievement3}`   
  ...
  workInput13.value =  `${el.work_achievement4}`   
  ...
  workInput14.value =  `${el.work_achievement5}`  
  ...
  workInput15.value =  `${el.work_achievement6}`   
  ...
  workInput16.value =  `${el.work_achievement7}`    
  ...
  workInput17.value =  `${el.work_achievement8}` 
  ...
  workInput18.value =  `${el.work_achievement9}` 
  ...
  workInput19.value =  `${el.work_achievement10}`   
